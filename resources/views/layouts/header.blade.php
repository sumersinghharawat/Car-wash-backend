                  ...
                  <li class="dropdown profile_details_drop">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" id="dropdownMenu3" aria-haspopup="true"
                      ...
                      <div class="profile_img">
                        <img src="https://st.hzcdn.com/simgs/32e1eeb90f5517dd_4-1803/home-design.jpg" style="background-color: #d3d3d3" class="rounded-circle" alt="" />
                    ...
                    <ul class="dropdown-menu drp-mnu" aria-labelledby="dropdownMenu3">
                      <li class="user-info">
                        <h5 class="user-name">{{ request()->user()->name }}</h5>
                        <span class="status ml-2">Available</span>
                      </li>
                      <li> <a href="{{ route('admin.profile') }}"><i class="lnr lnr-user"></i>My Profile</a> </li>
