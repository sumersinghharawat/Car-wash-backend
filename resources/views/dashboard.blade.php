    ...
    <div class="main-content">
      ...
      <div class="container-fluid content-top-gap">
        ...
        <div class="welcome-msg pt-3 pb-4">
          <h1>Hi <span class="text-primary">{{ request()->user()->name }}</span>, Welcome back</h1>
          <p>RJ19 Carwash Admin Panel</p>
        </div>
              ...
              <div class="row">
                <div class="col-sm-6 pr-sm-2 statistics-grid">
                  <div class="card card_border border-primary-top p-4">
                    ...
                    <h3 class="text-primary number"></h3>
                    <p class="stat-text">Today Earning</p>
                  </div>
                </div>
                <div class="col-sm-6 pl-sm-2 statistics-grid">
                  <div class="card card_border border-primary-top p-4">
                    ...
                    <p class="stat-text">Total Earning</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-sm-6 pr-sm-2 statistics-grid">
                  <div class="card card_border border-primary-top p-4">
                    ...
                    <h3 class="text-success number"></h3>
                ...
                <div class="col-sm-6 pl-sm-2 statistics-grid">
                  <div class="card card_border border-primary-top p-4">
                    ...
                    <p class="stat-text">Complete Bookings</p>
                  </div>
                </div>
              </div>
            </div>
