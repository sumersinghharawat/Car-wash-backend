                                    ...
                                    <table id="example" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="{{ $employee->profile_image}}" width="200"/></td>
                                                <td>({{ $employee->time_in }}/{{ $employee->time_out }})</td>
                                                <td>
                                                    @if ($employee->status == 1)
                                                        <button type="button" class="btn btn-success btn-style mt-4" onclick="changestatus({{ $employee->id }},0)" title="Active">A</button>
                                                    @else
                                                        <button type="button" class="btn btn-danger btn-style mt-4" onclick="changestatus({{ $employee->id }},1)" title="Deactive">D</button>
                                                    @endif
                                                </td>
                                                <td>
                                                    <div class="d-flex">
                                                        <a href="{{ url('addemployee') }}/{{ $employee->id }}" class="btn btn-primary btn-style m-2"><i class="fa fa-pencil"></i></a>
                                                        <button onclick="deleteemployeedata({{ $employee->id }})" class="btn btn-danger btn-style m-2"><i class="fa fa-trash"></i></button>
                                                    </div>
                                                </td>
                                            </tr>
                                            @endforeach
