                ...
                <div class="card-body">
                    <form method="post" id="addcategory" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="inputEmail3" class="col-sm-3 col-form-label input__label">Name</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control input-style" value="{{ $data->name }}" name="name" id="inputEmail3"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="email" class="form-control input-style" value="{{ $data->email }}" name="email" id="inputEmail3"
                                    placeholder="Enter Email">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputEmail3" class="col-sm-3 col-form-label input__label">Password</label>
                            <div class="col-sm-9">
                                <input type="password" class="form-control input-style" value="" name="password" id="inputEmail3"
                ...
                $.ajax({
                    ...
                    .done( function(result){
                        $("#alert").removeClass("alert-danger").addClass("alert-success")
                                        .removeClass("alert-warning").removeClass("d-none").html(result.message);
                        setTimeout(function(){
